...
export interface ApiBoardBoard extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    boardName: Schema.Attribute.String;
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::board.board'> &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    sa: Schema.Attribute.Relation<'oneToMany', 'api::column.column'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiColumnColumn extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    cards: Schema.Attribute.Relation<'oneToMany', 'api::task.task'>;
    columnName: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiTaskTask extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    statue: Schema.Attribute.Enumeration<
      ['\u00C0 faire', 'En cours', 'Termin\u00E9', 'space']
    >;
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    bg: Schema.Attribute.String & Schema.Attribute.Unique;
    blocked: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    boards: Schema.Attribute.Relation<'oneToMany', 'api::board.board'>;
    cards: Schema.Attribute.Relation<'oneToMany', 'api::task.task'>;
    color: Schema.Attribute.String & Schema.Attribute.Unique;
    ...
    profilePicture: Schema.Attribute.String & Schema.Attribute.Unique;
